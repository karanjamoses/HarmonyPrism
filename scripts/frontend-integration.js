 ...
 * This file demonstrates how to integrate Harmonyprism with a web frontend
 */

// For React/Vue/Angular applications
export class HarmonyprismClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new HarmonyprismClient(provider, contractAddress);
