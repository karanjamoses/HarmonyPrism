...
const contractABI = require("../artifacts/contracts/Harmonyprism.sol/Harmonyprism.json").abi;

program
    .name("harmonyprism-cli")
    .description("CLI tool for Harmonyprism smart contract")
    .version("1.0.0");
